...
\begin{table}[H]
\centering
\caption{Bán kính lớn nhất trong các nghiệm của $\rho(z)$ đối với họ BDF. Điều kiện nghiệm bị vi phạm kể từ $k=7$, đúng với kết quả cổ điển rằng BDF chỉ 0-ổn định khi $k \leq 6$.}
