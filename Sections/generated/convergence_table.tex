...
\begin{table}[H]
\centering
\caption{Sai số toàn cục tại $T=8$ của bài toán $y'=y(1-y),\ y(0)=0.1$. Bậc đo được là hệ số góc hồi quy của $\log E$ theo $\log h$, khớp với bậc lý thuyết $p$ của từng phương pháp.}
