...
\[
 ...
 \lambda_2=-5+O(h).
\]
Với $h=0.1$: $\lambda_1=0.9048=e^{-h}$, $\lambda_2=-5.3048$.
\end{tcolorbox}
\begin{tcolorbox}[title={Nhận xét}, colback=softred, colframe=warnred, colbacktitle=warnred]
Vì một nghiệm có môđun xấp xỉ $5>1$, sai số nhỏ bị khuếch đại rất nhanh qua từng bước lặp. Đo trên nghiệm số: tỉ số $|E_{n+1}|/|E_n| = 5.3048$, đúng bằng $|\lambda_2|$.
\end{tcolorbox}
\end{frame}
\begin{frame}
...
\scriptsize
\input{../Sections/generated/bdf_stability_tabular}
\end{columns}
\end{frame}
...
\begin{center}
\scriptsize
\input{../Sections/generated/convergence_tabular}
\end{center}
\vspace{0.4em}
\footnotesize
