...
% Tên nhóm lấy nguyên văn từ slides/main.tex (\author ở dòng 204).
\author{L. T. Nhân \and D. T. H. Yến \and N. H. Tú}
\date{\today}
...
$k \leq 6$ của họ BDF). Kho mã còn kèm ba hoạt ảnh cho thấy cơ chế đứng sau các kết
luận: sai số bị nghiệm ký sinh nhân lên sau từng bước, nghiệm số bám dần vào nghiệm
đúng khi lưới mịn đi, và nghiệm của đa thức ổn định rời khỏi đĩa đơn vị khi $h\lambda$
chạy dọc trục thực âm.
