...
\title{\color{titleblue}\textbf{DÀN BÀI CHI TIẾT BÁO CÁO (BẢN CHUẨN HÓA)}\\[0.5em]
\Large \textbf{PHƯƠNG PHÁP ĐA BƯỚC TUYẾN TÍNH}\\[0.3em]
\large \textit{\color{black}Phân tích hệ thống Sai số, tính nhất quán, ổn định và sự hội tụ}}
\author{}
\date{\today}
